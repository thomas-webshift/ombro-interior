<div class="card-realisatie h-100 position-relative ani op id-<?php the_id(); ?>">
  ...
  <img class="object-fit-cover w-100 vh-mobile" height="240" src="<?php the_post_thumbnail_url('large'); ?>" alt="<?php echo esc_attr(get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true)); ?>">
    ...
    <span class="fw-700 text-uppercase text-black mt-16 d-inline-block" class="btn"><?php _e( 'Bekijk realisatie', 'theme' ); ?><i class="fa fa-arrow-right ms-8" aria-hidden="true"></i></span>
  </a>
</div>